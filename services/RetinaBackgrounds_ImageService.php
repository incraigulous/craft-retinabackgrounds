...
class RetinaBackgrounds_ImageService extends BaseApplicationComponent
{
    ...
    protected function create1xImage(AssetFileModel $image)
    {
        ...
        $markup = $image->getUrl($params) . '" data-background-2x="' .  $image->getUrl();
    ...
    protected function create2xImage(AssetFileModel $image, AssetTransformModel $transform)
    {
        ...
        {
            $markup .= '" data-background-2x="' . $image->getUrl($params);
        }
